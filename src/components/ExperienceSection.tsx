...
const experiences = [
  {
    ...
    techStack: ["Django", "Celery", "React", "Web Workers", "PostgreSQL"],
    highlights: [
      "Built key modules for a real-time lawyer operations platform using Django and Celery for async workflows and event processing",
      "Improved React dashboards using Web Workers for debounced pagination, reducing UI-blocking operations by 40%",
      "Delivered end-to-end features, solved production bugs, and collaborated directly with founders",
    ],
  },
  {
    company: "Seller Setu",
    ...
    techStack: ["Golang", "RabbitMQ", "Django", "API Gateway"],
    highlights: [
      "Migrated production API Gateway from Django to Golang, improving throughput and reducing latency",
      "Implemented rate limiting and traffic safeguards to prevent throttling during peak hours",
